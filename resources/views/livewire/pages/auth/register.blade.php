...
<div>
        ...
        <form wire:submit="register">
            ...
            <div class="mt-4" x-data="{ show: false, length: 0 }">
                ...
                <div class="relative">
                    ...
                    <button type="button" x-on:click="show = !show" class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-400 hover:text-gray-600 mt-1" tabindex="-1">
    ...
    @else
        <div wire:key="verify-step">
            <h2 class="text-lg font-semibold text-gray-800 mb-2">Vérifiez votre email</h2>
            ...
            <form wire:submit="verifyCode">
                ...
                <div class="flex items-center justify-between mt-6">
                    <button type="button" wire:click="backToForm" class="text-sm text-gray-500 hover:text-gray-700 underline">
                        ← Retour
                    </button>

                    <div class="flex items-center gap-3">
                        <button type="button" wire:click="resendCode" class="text-sm text-indigo-600 hover:text-indigo-800 underline">
                            Renvoyer le code
                        </button>
